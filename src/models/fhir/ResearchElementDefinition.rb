module FHIR
  class ResearchElementDefinition < DomainResource
    ...
    field :typeName, type: String, default: 'ResearchElementDefinition'
    ...
    field :shortTitle, type:  # primitive
    embeds_one :_shortTitle, class_name: 'Extension'
    ...
    field :comment, type: Array # primitive
    embeds_many :_comment, class_name: 'Extension'
    ...
    embeds_one :type, class_name: 'ResearchElementType'
