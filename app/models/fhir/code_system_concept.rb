    ...
    def self.transform_json(json_hash, target = CodeSystemConcept.new)
      ...
      result['designation'] = json_hash['designation'].map { |var| 
        unless var['resourceType'].nil?
          ...
          CodeSystemConceptDesignation.transform_json(var) 
        end
      ...
      result['property'] = json_hash['property'].map { |var| 
        unless var['resourceType'].nil?
          ...
          CodeSystemConceptProperty.transform_json(var) 
        end
      } unless json_hash['property'].nil?
      result['concept'] = json_hash['concept'].map { |var| 
        unless var['resourceType'].nil?
          Object.const_get('FHIR::' + var['resourceType']).transform_json(var)
        else
          CodeSystemConcept.transform_json(var) 
        end
      } unless json_hash['concept'].nil?
