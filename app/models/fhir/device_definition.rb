module FHIR
  ...
  class DeviceDefinition < DomainResource
    ...
    def self.transform_json(json_hash, target = DeviceDefinition.new)
      ...
      result['udiDeviceIdentifier'] = json_hash['udiDeviceIdentifier'].map { |var| 
        unless var['resourceType'].nil?
          Object.const_get('FHIR::' + var['resourceType']).transform_json(var)
        else
          DeviceDefinitionUdiDeviceIdentifier.transform_json(var) 
        end
      } unless json_hash['udiDeviceIdentifier'].nil?
      ...
      result['deviceName'] = json_hash['deviceName'].map { |var| 
        unless var['resourceType'].nil?
          ...
          DeviceDefinitionDeviceName.transform_json(var) 
        end
      ...
      result['specialization'] = json_hash['specialization'].map { |var| 
        unless var['resourceType'].nil?
          ...
          DeviceDefinitionSpecialization.transform_json(var) 
        end
      ...
      result['shelfLifeStorage'] = json_hash['shelfLifeStorage'].map { |var| 
        unless var['resourceType'].nil?
          Object.const_get('FHIR::' + var['resourceType']).transform_json(var)
        else
          ProductShelfLife.transform_json(var) 
        end
      } unless json_hash['shelfLifeStorage'].nil?
      ...
      result['languageCode'] = json_hash['languageCode'].map { |var| 
        unless var['resourceType'].nil?
          Object.const_get('FHIR::' + var['resourceType']).transform_json(var)
        else
          CodeableConcept.transform_json(var) 
        end
      } unless json_hash['languageCode'].nil?
      result['capability'] = json_hash['capability'].map { |var| 
        unless var['resourceType'].nil?
          Object.const_get('FHIR::' + var['resourceType']).transform_json(var)
        else
          DeviceDefinitionCapability.transform_json(var) 
        end
      ...
      result['property'] = json_hash['property'].map { |var| 
        unless var['resourceType'].nil?
          ...
          DeviceDefinitionProperty.transform_json(var) 
        end
      ...
      result['material'] = json_hash['material'].map { |var| 
        unless var['resourceType'].nil?
          Object.const_get('FHIR::' + var['resourceType']).transform_json(var)
        else
          DeviceDefinitionMaterial.transform_json(var) 
        end
      } unless json_hash['material'].nil?
