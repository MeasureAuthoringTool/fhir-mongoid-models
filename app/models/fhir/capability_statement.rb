module FHIR
  ...
  class CapabilityStatement < DomainResource
    ...
    embeds_many :instantiates, class_name: 'PrimitiveCanonical'
    embeds_many :imports, class_name: 'PrimitiveCanonical'
    ...
    embeds_many :implementationGuide, class_name: 'PrimitiveCanonical'
    ...
    def self.transform_json(json_hash)
      result = CapabilityStatement.new
