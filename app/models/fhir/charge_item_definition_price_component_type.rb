module FHIR
  ...
  class ChargeItemDefinitionPriceComponentType < PrimitiveCode
    ...
    def self.transform_json(json_hash, extension_hash, target = ChargeItemDefinitionPriceComponentType.new)
