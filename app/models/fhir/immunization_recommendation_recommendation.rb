module FHIR
  ...
  class ImmunizationRecommendationRecommendation < BackboneElement
    ...
    def self.transform_json(json_hash, target = ImmunizationRecommendationRecommendation.new)
      ...
      result['vaccineCode'] = json_hash['vaccineCode'].map { |var| 
        unless var['resourceType'].nil?
          Object.const_get('FHIR::' + var['resourceType']).transform_json(var)
        else
          CodeableConcept.transform_json(var) 
        end
      } unless json_hash['vaccineCode'].nil?
      result['targetDisease'] = CodeableConcept.transform_json(json_hash['targetDisease']) unless json_hash['targetDisease'].nil?
      result['contraindicatedVaccineCode'] = json_hash['contraindicatedVaccineCode'].map { |var| 
        unless var['resourceType'].nil?
          Object.const_get('FHIR::' + var['resourceType']).transform_json(var)
        else
          CodeableConcept.transform_json(var) 
        end
      } unless json_hash['contraindicatedVaccineCode'].nil?
      result['forecastStatus'] = CodeableConcept.transform_json(json_hash['forecastStatus']) unless json_hash['forecastStatus'].nil?
      result['forecastReason'] = json_hash['forecastReason'].map { |var| 
        unless var['resourceType'].nil?
          Object.const_get('FHIR::' + var['resourceType']).transform_json(var)
        else
          CodeableConcept.transform_json(var) 
        end
      } unless json_hash['forecastReason'].nil?
      result['dateCriterion'] = json_hash['dateCriterion'].map { |var| 
        unless var['resourceType'].nil?
          Object.const_get('FHIR::' + var['resourceType']).transform_json(var)
        else
          ImmunizationRecommendationRecommendationDateCriterion.transform_json(var) 
        end
      } unless json_hash['dateCriterion'].nil?
      ...
      result['supportingImmunization'] = json_hash['supportingImmunization'].map { |var| 
        unless var['resourceType'].nil?
          Object.const_get('FHIR::' + var['resourceType']).transform_json(var)
        else
          Reference.transform_json(var) 
        end
      } unless json_hash['supportingImmunization'].nil?
      result['supportingPatientInformation'] = json_hash['supportingPatientInformation'].map { |var| 
        unless var['resourceType'].nil?
          Object.const_get('FHIR::' + var['resourceType']).transform_json(var)
        else
          Reference.transform_json(var) 
        end
      } unless json_hash['supportingPatientInformation'].nil?
