module FHIR
  ...
  class BiologicallyDerivedProductStorageScale < PrimitiveCode
    ...
    def self.transform_json(json_hash, extension_hash, target = BiologicallyDerivedProductStorageScale.new)
