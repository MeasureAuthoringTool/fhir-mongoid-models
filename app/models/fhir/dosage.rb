module FHIR
  ...
  class Dosage < BackboneElement
    ...
    def self.transform_json(json_hash, target = Dosage.new)
      ...
      result['additionalInstruction'] = json_hash['additionalInstruction'].map { |var| 
        unless var['resourceType'].nil?
          Object.const_get('FHIR::' + var['resourceType']).transform_json(var)
        else
          CodeableConcept.transform_json(var) 
        end
      } unless json_hash['additionalInstruction'].nil?
      ...
      result['doseAndRate'] = json_hash['doseAndRate'].map { |var| 
        unless var['resourceType'].nil?
          Object.const_get('FHIR::' + var['resourceType']).transform_json(var)
        else
          DosageDoseAndRate.transform_json(var) 
        end
      } unless json_hash['doseAndRate'].nil?
