module FHIR
  ...
  class EffectEvidenceSynthesis < DomainResource
    ...
    field :typeName, type: String, default: 'EffectEvidenceSynthesis'
    ...
    embeds_one :sampleSize, class_name: 'EffectEvidenceSynthesisSampleSize'
    embeds_many :resultsByExposure, class_name: 'EffectEvidenceSynthesisResultsByExposure'
    embeds_many :effectEstimate, class_name: 'EffectEvidenceSynthesisEffectEstimate'
    embeds_many :certainty, class_name: 'EffectEvidenceSynthesisCertainty'

    def self.transform_json(json_hash)
      result = EffectEvidenceSynthesis.new
