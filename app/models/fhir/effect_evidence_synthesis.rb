module FHIR
  ...
  class EffectEvidenceSynthesis < DomainResource
    ...
    def as_json(*args)
      ...
      unless self.exposureAlternative.nil? 
        result['exposureAlternative'] = self.exposureAlternative.as_json(*args)
      end
      ...
      unless self.resultsByExposure.nil?  || !self.resultsByExposure.any? 
        result['resultsByExposure'] = self.resultsByExposure.map{ |x| x.as_json(*args) }
      end
      unless self.effectEstimate.nil?  || !self.effectEstimate.any? 
        result['effectEstimate'] = self.effectEstimate.map{ |x| x.as_json(*args) }
      end
    ...
    def self.transform_json(json_hash, target = EffectEvidenceSynthesis.new)
      ...
      result['resultsByExposure'] = json_hash['resultsByExposure'].map { |var| 
        unless var['resourceType'].nil?
          Object.const_get('FHIR::' + var['resourceType']).transform_json(var)
        else
          EffectEvidenceSynthesisResultsByExposure.transform_json(var) 
        end
      } unless json_hash['resultsByExposure'].nil?
      result['effectEstimate'] = json_hash['effectEstimate'].map { |var| 
        unless var['resourceType'].nil?
          Object.const_get('FHIR::' + var['resourceType']).transform_json(var)
        else
          EffectEvidenceSynthesisEffectEstimate.transform_json(var) 
        end
      } unless json_hash['effectEstimate'].nil?
      result['certainty'] = json_hash['certainty'].map { |var| 
        unless var['resourceType'].nil?
          Object.const_get('FHIR::' + var['resourceType']).transform_json(var)
        else
          EffectEvidenceSynthesisCertainty.transform_json(var) 
        end
      } unless json_hash['certainty'].nil?
