module FHIR
  ...
  class CapabilityStatementRestResource < BackboneElement
    ...
    embeds_one :readHistory, class_name: 'PrimitiveBoolean'
    embeds_one :updateCreate, class_name: 'PrimitiveBoolean'
    embeds_one :conditionalCreate, class_name: 'PrimitiveBoolean'
    embeds_one :conditionalRead, class_name: 'ConditionalReadStatus'
    embeds_one :conditionalUpdate, class_name: 'PrimitiveBoolean'
    ...
    embeds_many :searchInclude, class_name: 'PrimitiveString'
    embeds_many :searchRevInclude, class_name: 'PrimitiveString'
