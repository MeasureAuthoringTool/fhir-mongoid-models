module FHIR
  ...
  class ConceptMap < DomainResource
    ...
    embeds_one :sourceUri, class_name: 'FHIR::PrimitiveUri'    
    embeds_one :sourceCanonical, class_name: 'FHIR::PrimitiveCanonical'    
    embeds_one :targetUri, class_name: 'FHIR::PrimitiveUri'    
    embeds_one :targetCanonical, class_name: 'FHIR::PrimitiveCanonical'    
    embeds_many :group, class_name: 'FHIR::ConceptMapGroup'    
    ...
    def as_json(*args)
      ...
      unless self.sourceUri.nil?
        result['sourceUri'] = self.sourceUri.value                        
        serialized = Extension.serializePrimitiveExtension(self.sourceUri) 
        result['_sourceUri'] = serialized unless serialized.nil?
      end          
      unless self.sourceCanonical.nil?
        result['sourceCanonical'] = self.sourceCanonical.value                        
        serialized = Extension.serializePrimitiveExtension(self.sourceCanonical) 
        result['_sourceCanonical'] = serialized unless serialized.nil?
      end          
      unless self.targetUri.nil?
        result['targetUri'] = self.targetUri.value                        
        serialized = Extension.serializePrimitiveExtension(self.targetUri) 
        result['_targetUri'] = serialized unless serialized.nil?
      end          
      unless self.targetCanonical.nil?
        result['targetCanonical'] = self.targetCanonical.value                        
        serialized = Extension.serializePrimitiveExtension(self.targetCanonical) 
        result['_targetCanonical'] = serialized unless serialized.nil?
      end          
