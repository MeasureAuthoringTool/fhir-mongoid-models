module FHIR
  ...
  class ValueSet < DomainResource
    ...
    embeds_one :immutable, class_name: 'FHIR::PrimitiveBoolean'    
    embeds_one :purpose, class_name: 'FHIR::PrimitiveMarkdown'    
    embeds_one :copyright, class_name: 'FHIR::PrimitiveMarkdown'    
    embeds_one :compose, class_name: 'FHIR::ValueSetCompose'    
    embeds_one :expansion, class_name: 'FHIR::ValueSetExpansion'    
    ...
    def as_json(*args)
      ...
      unless self.immutable.nil? 
        result['immutable'] = self.immutable.value
        serialized = Extension.serializePrimitiveExtension(self.immutable)            
        result['_immutable'] = serialized unless serialized.nil?
      end
      ...
      unless self.compose.nil? 
        result['compose'] = self.compose.as_json(*args)
      end
