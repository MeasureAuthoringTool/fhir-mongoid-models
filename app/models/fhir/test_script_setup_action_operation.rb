module FHIR
  ...
  class TestScriptSetupActionOperation < BackboneElement
    ...
    embeds_one :encodeRequestUrl, class_name: 'PrimitiveBoolean'
    embeds_one :method, class_name: 'TestScriptRequestMethodCode'
    embeds_one :origin, class_name: 'PrimitiveInteger'
    ...
    embeds_one :requestId, class_name: 'PrimitiveId'
    embeds_one :responseId, class_name: 'PrimitiveId'
