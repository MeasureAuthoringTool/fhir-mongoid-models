module FHIR
  ...
  class ContractTermAction < BackboneElement
    ...
    embeds_many :requesterLinkId, class_name: 'PrimitiveString'
    ...
    embeds_many :performerLinkId, class_name: 'PrimitiveString'
    embeds_many :reasonCode, class_name: 'CodeableConcept'
    embeds_many :reasonReference, class_name: 'Reference'
    embeds_many :reason, class_name: 'PrimitiveString'
    embeds_many :reasonLinkId, class_name: 'PrimitiveString'
