module FHIR
  # fhir/device_metric_category.rb
  class DeviceMetricCategory < PrimitiveCode
    ...
    def self.transform_json(json_hash, extension_hash, target = DeviceMetricCategory.new)
      result = target
